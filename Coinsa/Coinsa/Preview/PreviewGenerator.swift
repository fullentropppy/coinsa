...
private extension PreviewGenerator {
    ...
    private static func makeTokyoLocation(
        ...
        let tokyo = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: tokyoData.timeZoneIdentifier,
    ...
    private static func makeKyotoLocation(
        ...
        let kyoto = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: kyotoData.timeZoneIdentifier,
    ...
    private static func makeOsakaLocation(
        ...
        let osaka = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: osakaData.timeZoneIdentifier,
...
private extension PreviewGenerator {
    ...
    private static func makeSaintpLocation(
        ...
        let saintp = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: saintpData.timeZoneIdentifier,
...
private extension PreviewGenerator {
    ...
    private static func makeSeoulLocation(
        ...
        let seoul = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: seoulData.timeZoneIdentifier,
    ...
    private static func makeBusanLocation(
        ...
        let busan = Location(
            ...
            startDate: startDate,
            endDate: endDate,
            timeZoneIdentifier: busanData.timeZoneIdentifier,
...
private extension PreviewGenerator {
    ...
    private static func makeIstanbulLocation(trip: Trip, options: PreviewOptions) -> Location {
        ...
        let istanbul = Location(
            ...
            timeZoneIdentifier: istanbulData.timeZoneIdentifier,
